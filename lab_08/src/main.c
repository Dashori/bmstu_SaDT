    ...
    while (key)
    {
        ...
        switch(key)
        {
            ...
            case(3):
            {
                if (flag_graph)
                {
                    printf("\nДля вывода матрицы смежности необходимо считать её в пункте 1 или 2.\n\n");
                    break;
                }
                print_matrix(graph);
                break;
            ...
            case(4):
            {
                if (flag_graph)
                {
                    printf("\nДля вывода графа необходимо считать его в пункте 1 или 2.\n\n");
                    break;
                }
            ...
            case(5):
            {
                if (flag_graph)
                {
                    printf("\nДля работы с графом необходимо считать его в пункте 1 или 2.\n\n");
                    break;
                }
